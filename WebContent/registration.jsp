...
<html>
    <head>
        ...
        <link href="RegistrationStyling.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
    <div class="cont">
    <div class="sub-cont">
        ...
        <div class="img-text m-up">
          ...
          <div class="img-btn"><a href="login.jsp">Sign In</a>
        </div> 
        <br><img src="images/registration-security.png" width="280px" height="260px">        
